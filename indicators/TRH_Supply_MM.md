...
**S1 tight MM:** last opposing candle before displacement → ENTRY=proximal · SL=distal of that pocket (e.g. 4396.69 / 4398.46). Min zone height default 1.0 · keep-score default 55 so tight boxes still draw.
