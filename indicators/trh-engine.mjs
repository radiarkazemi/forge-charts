...
function touchCount(bars, i, level, lookback, tol) {
  let touches = 0;
...
function scanTrhSetups(bars, cfg = DEFAULT_TRH_CONFIG) {
  ...
  for (let i = 0; i < bars.length; i++) {
    ...
    if (pending.dir === 1) {
      ...
      const microBreak = b.close > b.open && (b.high >= prevBaseHigh || b.close >= distal + width * 0.65);
      ...
      const microBreak = b.close < b.open && (b.low <= prevBaseLow || b.close <= distal - width * 0.65);
