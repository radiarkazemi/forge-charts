...
export const INDICATOR_CATALOG: IndicatorCatalogEntry[] = [
  ...
  // Financials (metrics)
  { id: "fin:eps", label: "Earnings Per Share", group: "Income Statement", tab: "financials", role: "metric" , kind: "sma"},
  { id: "fin:revenue", label: "Total Revenue", group: "Income Statement", tab: "financials", role: "metric" , kind: "ema"},
  { id: "fin:net-income", label: "Net Income", group: "Income Statement", tab: "financials", role: "metric" , kind: "sma"},
  { id: "fin:ebitda", label: "EBITDA", group: "Income Statement", tab: "financials", role: "metric" , kind: "ema"},
  { id: "fin:pe", label: "Price to Earnings Ratio", group: "Valuation", tab: "financials", role: "metric" , kind: "rsi"},
  { id: "fin:pb", label: "Price to Book Ratio", group: "Valuation", tab: "financials", role: "metric" , kind: "rsi"},
  { id: "fin:ps", label: "Price to Sales Ratio", group: "Valuation", tab: "financials", role: "metric" , kind: "rsi"},
  { id: "fin:debt", label: "Total Debt", group: "Balance Sheet", tab: "financials", role: "metric" , kind: "atr"},
  { id: "fin:cash", label: "Cash and Equivalents", group: "Balance Sheet", tab: "financials", role: "metric" , kind: "vwap"},
  { id: "fin:assets", label: "Total Assets", group: "Balance Sheet", tab: "financials", role: "metric" , kind: "sma"},
  { id: "fin:margin", label: "Profit Margin", group: "Ratios", tab: "financials", role: "metric" , kind: "rsi"},
  { id: "fin:roe", label: "Return on Equity", group: "Ratios", tab: "financials", role: "metric" , kind: "rsi"},
  { id: "fin:roa", label: "Return on Assets", group: "Ratios", tab: "financials", role: "metric" , kind: "cci"},
  // Community scripts
  { id: "com:rsi-div", label: "RSI Divergence Indicator", group: "Oscillators", tab: "community", role: "script", author: "ChartMaster42" , kind: "rsi"},
  { id: "com:supertrend-pro", label: "Supertrend Pro+", group: "Trend", tab: "community", role: "script", author: "AlphaSignals" , kind: "supertrend"},
  { id: "com:vol-profile", label: "Volume Profile Lite", group: "Volume", tab: "community", role: "script", author: "QuantForge" , kind: "vwap"},
  { id: "com:session-map", label: "Session Map Overlay", group: "Time", tab: "community", role: "script", author: "DayTraderX" , kind: "vwap"},
  { id: "com:smart-money", label: "Smart Money Concepts", group: "Trend", tab: "community", role: "script", author: "ICTFan" , kind: "donchian"},
  { id: "com:order-blocks", label: "Order Blocks Detector", group: "Trend", tab: "community", role: "script", author: "SMCTools" , kind: "pivot"},
  { id: "com:liquidity-hunt", label: "Liquidity Hunt Zones", group: "Levels", tab: "community", role: "script", author: "FlowDesk" , kind: "pivot"},
  // Invite-only
  ...
  { id: "pat:double-top", label: "Double Top / Bottom", group: "Reversal", tab: "patterns", role: "pattern" , tool: "headshoulders"},
  { id: "pat:flag", label: "Bull / Bear Flag", group: "Continuation", tab: "patterns", role: "pattern" , tool: "trianglepattern"},
  { id: "pat:wedge", label: "Rising / Falling Wedge", group: "Reversal", tab: "patterns", role: "pattern" , tool: "elliotttriangle"},
];
