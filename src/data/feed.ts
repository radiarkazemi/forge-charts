...
export const UNIVERSE: SymbolInfo[] = [
  ...
  { ticker: "EURUSD", name: "Euro / U.S. Dollar", exchange: "FXPRO", type: "fx", pricePrecision: 5 },
  { ticker: "GBPUSD", name: "British Pound / U.S. Dollar", exchange: "FXPRO", type: "fx", pricePrecision: 5 },
  { ticker: "USDJPY", name: "U.S. Dollar / Japanese Yen", exchange: "FXPRO", type: "fx", pricePrecision: 3 },
  { ticker: "AUDUSD", name: "Australian Dollar / U.S. Dollar", exchange: "FXPRO", type: "fx", pricePrecision: 5 },
  { ticker: "USDCHF", name: "U.S. Dollar / Swiss Franc", exchange: "FXPRO", type: "fx", pricePrecision: 5 },
  ...
  { ticker: "XAUUSD", name: "Gold Spot / U.S. Dollar", exchange: "FXPRO", type: "metal", pricePrecision: 2 },
  { ticker: "USOIL", name: "WTI Crude Oil", exchange: "FXPRO", type: "metal", pricePrecision: 2 },
