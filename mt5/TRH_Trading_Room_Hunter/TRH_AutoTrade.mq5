...
int OnInit()
{
   ...
   WatchEmit("TRH", "info", "", "INIT", 0, 0, 0, "", "TRH EA attached + watch bridge on", 0);
...
void OnTick()
{
   ...
   ExpireStalePendings();
   ManageBreakEven();
   WatchHeartbeat("TRH", "alive", "OnTick");
   ...
   WatchStatus("TRH", last.dir, last.entry, last.sl, last.tp, TrhModeLabel(last.setupMode),
   ...
   WatchSetup("TRH", last.dir, last.entry, last.sl, last.tp, TrhModeLabel(last.setupMode), last.barTime,
              StringFormat("age=%d lots=%s", ageBars, DoubleToString(previewLots, 2)));
