...
assert(sources["TRH_AutoTrade.mq5"].includes("v3.37"), "EA version 3.37");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("TRH_IND_BUILD 232"), "Indicator build 232");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("TRH_MIN_ENGINE 230"), "Indicator requires Engine 230");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("InpOnlyLast        = true"), "OnlyLast matches Pine default");
assert(sources["TRH_Engine.mqh"].includes("cfg.fvgSlExtraAtr   = 0.20"), "Engine Mode B SL pad 0.20 (Pine exact)");
