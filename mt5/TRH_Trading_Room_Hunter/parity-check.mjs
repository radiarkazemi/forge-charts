...
assert(sources["TRH_AutoTrade.mq5"].includes("v3.39"), "EA version 3.39");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("TRH_IND_BUILD 234"), "Indicator build 234");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("TRH_MIN_ENGINE 232"), "Indicator requires Engine 232");
assert(sources["TRH_Trading_Room_Hunter.mq5"].includes("InpOnlyLast        = false"), "History shown by default");
...
assert(sources["TRH_Engine.mqh"].includes("cfg.fvgMinRiskAtr   = 1.55"), "Engine Mode B min risk 1.55 ATR");
assert(sources["TRH_Engine.mqh"].includes("TrhFvgWideEnough"), "Engine has TrhFvgWideEnough");
...
assert(sources["TRH_AutoTrade.mq5"].includes("InpMinFvgPoints"), "EA exposes min FVG points");
