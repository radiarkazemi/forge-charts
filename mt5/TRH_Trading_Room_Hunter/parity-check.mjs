...
assert(sources["TRH_Engine.mqh"].includes("TrhClampModeBQuality"), "Engine clamps stale Mode B inputs");
assert(sources["TRH_Engine.mqh"].includes("if(cfg.minFvgPoints  < 1.50)"), "Clamp rejects sub-1.50pt FVG");
